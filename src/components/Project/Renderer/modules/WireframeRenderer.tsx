...
import { Monitor, Box, Zap, Database, ListTodo, CheckCircle2 } from 'lucide-react';
...
const WireframeRenderer: React.FC<WireframeRendererProps> = ({ data }) => {
            ...
            <article key={i} className={styles.epicItem}>
              ...
              <div className={styles.epicBody}>
                ...
                {(screen.layout_regions || []).map((region: any, j: number) => (
                  <div key={j} className={styles.criteriaSection}>
                    ...
                    <ul className={styles.criteriaList}>
                      {(region.components || []).map((comp: any, k: number) => (
                        <li key={k} className={styles.criteriaItem}>
